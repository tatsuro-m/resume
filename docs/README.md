...
#### 小規模自治体向けワクチン摂取予約システムの新規開発（2021/04 ~ 2021/05）

[プロジェクト概要]  
小規模自治体向けに、ワクチン摂取の予約システムを新規開発。
...
新規開発を0から運用まで担当した経験があります。  
バックエンド、クラウド技術が得意であり、特にその領域でチームに貢献することができます。  
...
- Go を利用した開発に携わりたいです
- AWS, GCP 等のクラウド技術を活用した開発に携わりたいです
